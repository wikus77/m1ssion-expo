...
-- Questa è una versione backup del SQL necessario per creare manualmente la tabella
-- attraverso l'SQL Editor di Supabase se tutto il resto fallisce

-- Prima, crea la funzione di supporto per controllare se una tabella esiste
...
-- Quindi, crea una funzione per eseguire comandi SQL amministrativi in modo sicuro
