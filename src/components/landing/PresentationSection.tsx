    ...
    <section className="relative py-20 px-4 bg-black" style={{ opacity: 1, visibility: "visible" }}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg mb-6 max-w-3xl mx-auto text-gray-200">
            This is <span className="text-[#00E5FF] font-bold">M1</span><span className="text-white font-bold">SSION<span className="text-xs align-top">™</span></span>. The countdown has begun. Are you ready?
          </p>
